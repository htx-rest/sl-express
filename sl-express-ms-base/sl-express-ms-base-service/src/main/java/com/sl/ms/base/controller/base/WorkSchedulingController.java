...
public class WorkSchedulingController {
    ...
    @PostMapping("batch")
    @ApiOperation("批量新增排班")
    public ResponseEntity batch(@RequestBody List<WorkSchedulingAddDTO> workSchedulingAddDTOList) {
    ...
    public ResponseEntity delete(@PathVariable("id") Long id, @PathVariable("operator") Long operator) {
    ...
    @ApiOperation("更新排班")
    @PutMapping("")
    public ResponseEntity update(@RequestBody WorkSchedulingUpdateDTO workSchedulingUpdateDTO) {
