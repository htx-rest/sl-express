...
public class TruckTypeServiceImpl extends ServiceImpl<TruckTypeMapper, TruckTypeEntity>
    ...
    public IPage<TruckTypeEntity> findByPage(Integer page, Integer pageSize, String name, BigDecimal minAllowableLoad, BigDecimal maxAllowableLoad, BigDecimal minAllowableVolume, BigDecimal maxAllowableVolume, Long id) {
        ...
        LambdaQueryWrapper<TruckTypeEntity> lambdaQueryWrapper = Wrappers.<TruckTypeEntity>lambdaQuery()
                ...
                .like(id != null, TruckTypeEntity::getId, id)
                .ge(minAllowableLoad!=null,TruckTypeEntity::getAllowableLoad, minAllowableLoad)
                .lt(maxAllowableLoad!=null,TruckTypeEntity::getAllowableLoad, maxAllowableLoad)
                .ge(minAllowableVolume!=null,TruckTypeEntity::getAllowableVolume, minAllowableVolume)
                .lt(maxAllowableVolume!=null,TruckTypeEntity::getAllowableVolume, maxAllowableVolume)
                .eq(TruckTypeEntity::getStatus, Constant.DATA_DEFAULT_STATUS)
    ...
    public List<TruckTypeEntity> findAll(List<Long> ids) {
        ...
        lambdaQueryWrapper.eq(TruckTypeEntity::getStatus, Constant.DATA_DEFAULT_STATUS);
