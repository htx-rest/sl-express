<template>
  <div class="add-form maps-details-box">
    <el-dialog :title="titleInfo.text" :visible.sync="dialogFormVisible">
      <div class="content">
        <baidu-map
          class="mapsClass"
          :center="center"
        ...
        >
          <!-- <bm-polyline
            ...
            :stroke-weight="2"
          ></bm-polyline> -->
          <bm-driving :panel="false" :start="startArea" :end="endArea" :auto-viewport="true" location="中国"></bm-driving>
