<template>
  <div class="dashboard-container transport-task customer-list-box">
    ...
    <!-- 分配司机弹窗 -->
    <!-- <AllotDriver></AllotDriver> -->
    <!-- 手动调整弹窗 -->
    <!-- <HandDispatch></HandDispatch> -->
  </div>
</template>
<script>
import { transportList, transportListCount, cancelTransportTask, dispatchTransportTask, getUseCarSuccess } from '@/api/transport'
import {
  tripsList,
  carByTrips
} from '@/api/transit'
