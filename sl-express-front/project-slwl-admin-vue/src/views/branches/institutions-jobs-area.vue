      ...
      >
        ...
        >
          ...
          >
            <span>作业范围</span>
            <div
              v-if="isShowOperation && this.currentNode.type ===3"
...
export default {
  ...
  methods: {
    ...
    async handleNodeClick(data) {
      ...
      console.log(data, viewPointInfo, 'data')
    ...
    async getList() {
      ...
      console.log(this.instituJobDataList, 'this.instituJobDataList')
