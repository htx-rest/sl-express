      ...
      >
        <div class="header-box">
          ...
          <div
            style="float: right"
          >
            <!-- <el-tooltip effect="dark" content="点击编辑释放绘制电子围栏功能" placement="top"> -->
            <el-button
              v-show="showEdit"
              style="
            ...
            >编辑</el-button>
            <!-- </el-tooltip> -->
            <!-- <el-tooltip class="item" effect="dark" content="点击保存上传绘制好的电子围栏" placement="top"> -->
            <el-button
              v-show="showSave"
              style="
                background-color: #e15536;
...
<script>
// import { getMapScope } from '@/api/institutions'
...
.map-content {
  ...
  // /deep/ .map>div:first-child{
  //    height: 754px!important;
  // }
  // /deep/ .maps.active>div:first-child{
  //   display: none;
  // }
  .card-box {
    border-radius: 4px;
