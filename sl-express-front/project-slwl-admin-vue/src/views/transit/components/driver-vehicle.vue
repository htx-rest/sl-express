        ...
        <el-card shadow="never" class="form-box">
          <div class="form-item-box">
            <div class="form-item">
              ...
              <el-input v-model="driverTrucks.truckName" :disabled="disabled" placeholder="请输入当前使用车辆" />
            </div>
            <div class="form-item">
              <span class="span-title">车辆所属线路：</span>
              <el-input v-model="driverTrucks.lineName" :disabled="disabled" placeholder="请输入车辆所属线路" />
            </div>
            <div class="form-item">
              <span class="span-title">车辆所属车次：</span>
              <el-input v-model="driverTrucks.tripsName" :disabled="disabled" placeholder="请输入车辆所属车次" />
            </div>
          </div>
        </el-card>
        <div class="footer-box">
          <el-button class="cancel-btn" @click="handleEditDriverList()">返回</el-button>
        </div>
      </div>
    </el-card>
  </el-container>
