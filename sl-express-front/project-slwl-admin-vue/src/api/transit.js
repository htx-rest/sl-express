...
// 获取车队类型分页数据
export const fleetList = data => createAPI(`/web-manager/transfor-center/bussiness/fleet/page`, 'get', data)
// 添加车队
export const fleetAdd = data => createAPI(`/web-manager/transfor-center/bussiness/fleet`, 'post', data)
// 删除车队
export const fleetDel = data => createAPI(`/web-manager/transfor-center/bussiness/fleet/${data}`, 'delete', data)
// 获取车队详情
export const fleetDetail = data => createAPI(`/web-manager/transfor-center/bussiness/fleet/${data}`, 'get', data)
// 更新车队
export const fleetUpdate = (id, data) => createAPI(`/web-manager/transfor-center/bussiness/fleet/${id}`, 'put', data)
// 根据车辆获取绑定司机
