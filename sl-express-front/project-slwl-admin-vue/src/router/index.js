...
export const constantRoutes = [
  ...
  //       meta: { title: '订单管理', icon: 'business', navShow: false }
  //     }
  //   ]
  // },
  {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'line-type',
        component: () => import('@/views/transit/line-type'),
        name: 'line-type',
        meta: { title: '线路类型', noCache: true }
      },
      {
        path: 'car-register',
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'agency-data-board',
        component: () => import('@/views/transport/agency-data-board'),
        name: 'agency-data-board',
        meta: { title: '机构数据看板', noCache: true, showScroll: true }
      },
      {
        path: 'line-manage',
