...
<script setup>
import { ref, reactive, onMounted,onUpdated, watch, nextTick, computed } from 'vue';
// 接口
...
onUpdated(() => {
	// nextTick(()=>{
	// 	weight.value = Number(props.detailsData.weight)
	// 	volume.value = Number(props.detailsData.volume)?Number(props.detailsData.volume):0
	// })
