<template>
	<view class="goodsSearch">
		...
		<!-- 最近寄递 -->
		<!-- 		<view class="recent-send" v-if='!isFocus && !isInput && !searchValue'>
			<view class="recent-send-title">最近寄递：</view>
			<view class="recent-send-list">
				<view class="recent-send-item" v-for="(item,index) in recentSendList" :key='index'>
					{{item.label}}
				</view>
			</view>
		</view> -->
