	...
	onLoad(() => {
		uni.getSystemInfo({
			success: (res) => {
				...
				console.log(res.statusBarHeight, uni.getMenuButtonBoundingClientRect().top, uni
					.getMenuButtonBoundingClientRect().bottom, uni
					.getMenuButtonBoundingClientRect().height, 'res.statusBarHeight')
			}
		})
	})
	// ------定义方法------
