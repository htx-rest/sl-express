...
const _sfc_main = {
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    let someOrderList = common_vendor.reactive({
      data: []
    });
      ...
      return common_vendor.e({
        ...
        e: common_vendor.f(common_vendor.unref(allOrderList).data, (item, index, i0) => {
          return common_vendor.e({
            ...
            n: [23005, 23008].includes(item.status)
          }, [23005, 23008].includes(item.status) ? {
            ...
            K: index,
            L: common_vendor.o(($event) => handleToOrderInfo(_ctx.event, item.id, item.transportOrderId), index)
          });
        }),
