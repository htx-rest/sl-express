  ...
  setup(__props, { emit }) {
    ...
    common_vendor.onLoad(() => {
      common_vendor.index.getSystemInfo({
        success: (res) => {
          ...
          console.log(res.statusBarHeight, common_vendor.index.getMenuButtonBoundingClientRect().top, common_vendor.index.getMenuButtonBoundingClientRect().bottom, common_vendor.index.getMenuButtonBoundingClientRect().height, "res.statusBarHeight");
        }
      });
    });
    ...
    const getStaticNum = () => {
      pages_api_order.getGoodsNum().then((res) => {
        ...
        console.log(res, staticNum.data, "\u83B7\u53D6\u5BC4\u4EF6\u548C\u6536\u4EF6\u7684\u6570\u91CF");
      });
    };
